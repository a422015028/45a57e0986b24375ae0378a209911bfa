...
if (packageName == 'com.intsig.camscanner') {
    ...
    // common.hookAllConstructors('com.intsig.tsapp.sync.AppConfigJson', function (param) {
    common.hookAllMethods('com.intsig.tsapp.sync.AppConfigJson', 'parse', function (param) {

        common.log('args:' + param);
        common.log('args:' + param.args.length);
